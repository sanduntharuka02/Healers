	...
	<div class="row">
	    ...
	    <div class="col-lg-12" id="crud_reload_position">
			<div class="present_post_details text-left">
				...
				<?php require_once 'models/process_fruitMarket.php';?>
				...
				<div id="crud_wrapper" style="width:100%;margin: 0 auto;">
					<form action="models/process_fruitMarket.php" method="POST" id="product_items_admin_CRUD" class="form-bg-all-glass" enctype="multipart/form-data">
		...
		<div id="index_table_section" class="table-responsive" style="overflow: auto;width: 90% !important;margin: 0px auto !important;" >
			...
			if ($result->num_rows > 0) {
			  ...
			  while($row = $result->fetch_assoc()) {
				    ...
				    <td>".$row["price"]."</td>
				    <td>".$row["address"]."</td>
				    <td><img src='catelog/images/products/".$row["product_image"]."' style='width:120px; height:70px;'/></td>
				    <td>".$row["status"]."</td>";
				  }
			   ?>
			   ...
			   ?>
			    <td>
				    <a href="admin_fruitMarket.php?edit=<?php echo $row["id"]; ?>" class="btn btn-info">Edit</a>&emsp;
					<a href="admin_fruitMarket.php?remove=<?php echo $row["id"]; ?>" class="btn btn-danger" style="color:#ffffff !important;">
                      Delete</a>
				</td>
